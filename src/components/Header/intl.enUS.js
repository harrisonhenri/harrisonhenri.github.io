const header_enUS = {
  ...
  info: {
    ...
    formation:
      '<strong>Formation:</strong> Eletronic Enginner - UFBA (Salvador - BA) - 2014/2020. Currently pursuing a Master’s in Machine Learning and Theory of Control at UFBA - 2026/2028.',
    certification:
      '<strong>Certifications:</strong> AWS Solutions Architect, Ignite, Full Cycle, Data Science Codenation.',
    employ:
      '<strong>Current role:</strong> Systems specialist at <company>Grupo Boticário</company>',
  },
  bio: {
    title: 'Bio',
    paragraph:
